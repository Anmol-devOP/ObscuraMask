...
def chatlocal(values,instruction):
    ...
    # )
        ...
        # Format the prompt
    prompt = f"""System: You are a data transformation expert focused on changing personally identifiable information (PII) to ensure privacy and security.

User Input: {values}
Instruction: {instruction}

Please transform the data according to the instruction while maintaining its contextual relevance."""
